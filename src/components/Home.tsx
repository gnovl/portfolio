    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div className="min-h-screen md:mx-auto text-center pt-4 md:pt-4 p-4 max-w-6xl">
          ...
          >
          <img src="./img/portfolioDesign.png" alt="Hero Image"
        ...
        <p className="text-xl text-center mt-2">
          ...
          t('translation.home.paragraphs.header2')
            ...
            <p className="text-base text-justify mt-4">
              {i18n.language === 'en' ? (
                 /* English content */
                <>{generateSpaces(6)}👋 Welcome to my portfolio, your friendly guide through the ever-evolving tech terrain. Unlike traditional tech platforms, this is a personal space where I extend a hand to fellow tech enthusiasts like you. I comprehend the challenges of staying current in this dynamic field, and my commitment is straightforward: to assist you in your pursuits.</>
                 ) : (
                 /* Translated content */
               <>{generateSpaces(6)}{t('translation.home.paragraphs.paragraph1')}</>
                )}
             </p>
           <p className="text-base text-justify mt-4">
              {i18n.language === 'en' ? (
