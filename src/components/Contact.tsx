  ...
  return (
    ...
    t('translation.home.contact.labels.name')
            ...
            <input
              type="text"
              {...register("name", {
                required: t('translation.home.contact.validation.name.required'),
                maxLength: {
                  value: 10,
                  message: t('translation.home.contact.validation.name.maxLength'),
                },
                pattern: {
                  value: /^[A-Za-z]+$/i,
                  message: t('translation.home.contact.validation.name.pattern'),
                },
              })}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t('translation.home.contact.placeholders.message')}
            />
            {errors.message && (
